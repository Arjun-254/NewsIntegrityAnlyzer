...
export const UserInterface = () => {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-r bg-cover bg-center from-indigo-200 to-indigo-100  h-screen max-h-screen mt-6 pt-10 no-scrollbar overflow-y-auto ">
      ...
      <div className="justify-evenly items-center mx-auto flex bottom-0 sm:w-3/4 left-0 right-0 bg-gray-200 border-1 py-6 px-2 w-full lg:w-9/12 rounded-3xl mb-6">
