...
export const UserInterface = () => {
  ...
  return (
    ...
    <div className="justify-evenly items-center mx-auto flex bottom-0 left-0 right-0 bg-gray-200 border-1 py-6 px-2 w-11/12 lg:w-10/12 rounded-3xl mb-6">
      <div className="flex flex-row justify-center w-full ">
        <div className="flex flex-col w-full md:w-11/12 items-center justify-center">
          <div className="flex flex-row justify-center items-center w-full md:w-11/12">
            <input
              ...
              className="border border-gray-300 p-2 rounded-md justify-center flex items-center w-full"
        ...
        <div className="flex justify-end items-end flex-row w-2/6">
          {clicktranscribe && (
            <CirclesWithBar
              height="40"
              width="40"
