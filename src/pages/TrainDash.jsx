...
export default function TrainDash() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const responseData = await fetch(
        "https://a4db-34-168-237-223.ngrok-free.app/get_train_data",
        {
          method: "POST",
          headers: {
  ...
  const handleIVRS = async (train) => {
    try {
      const response = await fetch(
        "https://a4db-34-168-237-223.ngrok-free.app/make_call",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSMS = async (train) => {
    try {
      const response = await fetch(
        "https://a4db-34-168-237-223.ngrok-free.app/make_SMS",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAnnouncement = (train) => {
    try {
      ...
      const announcementString = `${train.trainName} (${train.trainNumber}) departing from platform ${train.platformNumber} at ${train.trainTime}`;
